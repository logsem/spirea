...
Lemma tac_wp_pure `{!nvmBaseFixedG Σ, !extraStateInterp Σ, nvmBaseDeltaG Σ} Δ Δ' s E K e1 e2 TV φ n Φ :
...
Lemma tac_wp_value_noncfupd `{!nvmBaseFixedG Σ, !extraStateInterp Σ, nvmBaseDeltaG Σ} Δ s E Φ v TV :
  envs_entails Δ (Φ (ThreadVal v TV)) → envs_entails Δ (WP (ThreadState (Val v) TV) @ s; E {{ Φ }}).
Proof. rewrite envs_entails_eq=> ->. by apply wp_value. Qed.

(* Lemma tac_wp_value `{!nvmBaseFixedG Σ, !extraStateInterp Σ, nvmBaseDeltaG Σ} Δ s E (Φ : val → iPropI Σ) v : *)
(*   envs_entails Δ (|={E}=> Φ v) → envs_entails Δ (WP (Val v) @ s; E {{ Φ }}). *)
(* Proof. rewrite envs_entails_eq=> ->. by rewrite wp_value_fupd. Qed. *)

(* Lemma tac_wp_value_fupd `{!nvmBaseFixedG Σ, !extraStateInterp Σ, nvmBaseDeltaG Σ} Δ s E Φ v : *)
...
Lemma tac_wp_bind `{!nvmBaseFixedG Σ, !extraStateInterp Σ, nvmBaseDeltaG Σ} K Δ s E Φ e TV f :
