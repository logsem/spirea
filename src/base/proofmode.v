...
Lemma tac_wp_pure `{!nvmG Σ} Δ Δ' s E K e1 e2 TV φ n Φ :
...
Lemma tac_wp_value_noncfupd `{!nvmG Σ} Δ s E Φ v TV :
...
(* Lemma tac_wp_value_fupd `{!nvmG Σ} Δ s E Φ v : *)
...
Lemma tac_wp_value `{!nvmG Σ} Δ s E (Φ : _ → iPropI Σ) v TV :
