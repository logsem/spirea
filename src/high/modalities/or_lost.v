(** TODO: I don't think this [or_lost] modality is useful at all.
 ** The majority of its usage seem to be in the [post_crash_modality.v],
 ** whose functionality has been completely replaced by [nextgen] modality
 ** instead. *)
