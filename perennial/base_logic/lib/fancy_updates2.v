...
Definition uPred_fupd2_def `{!invGS Σ} `{Ω : gGenCmras Σ} (E1a E1b : coPset) (E2a E2b : coPset) (P : iProp Σ) : iProp Σ :=
...
Global Arguments uPred_fupd2 {Σ _ Ω}.
Lemma uPred_fupd2_eq `{!invGS Σ} `{Ω : gGenCmras Σ} : uPred_fupd2 = uPred_fupd2_def.
...
Lemma fupd2_soundness `{!invGpreS Σ} `{Ω : gGenCmras Σ} `{!lcGpreS Σ} n E1 E1' E2 E2' (φ : Prop) :
...
Proof.
  ...
  iMod wsat_alloc as (Hinv -> Hinvpre) "[Hw HE]".
