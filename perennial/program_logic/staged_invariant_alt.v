...
Definition wpc_crash_modality `{!irisGS Λ Σ Ω, !crashGS Σ} E1 mj Φc :=
  ((∀ g1 ns D κs,
       let E2 :=  ⊤ ∖ D in
...
Definition wpc_value_modality `{!irisGS Λ Σ Ω, !crashGS Σ} E1 mj Φc :=
  ((∀ q g1 ns D κs,
       let E2 :=  ⊤ ∖ D in
...
Section def.
Context `{IRISG: !irisGS Λ Σ Ω, !crashGS Σ}.
